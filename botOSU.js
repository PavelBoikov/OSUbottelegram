...
Если вашей группы нет в списке и вы хотели бы чтобы ее добавили воспользуйтесб командой /contact.
И напишите номер своей группе в ВК создателю.
` 
));
bot.help((ctx)=> ctx.reply(GROUP_LIST));
